    ...
    <div class="ui item" style="margin: 0 auto 0 auto;">
        ...
        <div class="ui dropdown item"><i class="shopping  cart icon"></i>Modulo Venta <i class="dropdown icon"></i>
            <div class="menu">
                ...
                <a class="ui item" href="?opcion=clientes"><i class="id badge icon"></i><label>Registro de
                        Clientes</label> </a>
                <!-- <a class="ui item"href="?opcion=List_Cliente"><i class="file alternate icon"></i><label>Listado de Clientes</label></a> -->
                <a class="ui item" href="?opcion=list_ventas"><i class="file alternate icon"></i><label>Listado de
                        Facturas</label></a>
            </div>
        </div>
        <div class="ui dropdown item"><i class="money bill alternate icon"></i>Modulo Caja <i class="dropdown icon"></i>
            <div class="menu">
                <a class="ui item" href="?opcion=caja"><i class="money bill alternate icon"></i><label>Cuadre Caja
                        Diario</label></a>
            </div>
        ...
        <div class="ui dropdown item"><i class="file alternate icon"></i>Facturas Compra <i class="dropdown icon"></i>
            <div class="menu">
                <a class="ui item" href="?opcion=ingresofact"><i
                        class="shopping  cart icon"></i><label>Compras</label></a>
                <a class="ui item" href="?opcion=provedores"><i
                        class="handshake  icon"></i><label>Provedores</label></a>
    ...
    <div class="ui top  borderless fluid  huge menu">
        ...
        <div class="ui vertical borderless inverted fluid menu" style="display: none;">
            <div class="item">
                ...
                <a class="ui item" href="?opcion=clientes"><i class="id badge icon"></i><label>Registro de
                        Clientes</label> </a>
                <a class="ui item" href="?opcion=List_Cliente"><i class="file alternate icon"></i><label>Listado de
                        Clientes</label></a>
                <a class="ui item" href="?opcion=list_ventas"><i class="file alternate icon"></i><label>Listado de
                        Facturas</label></a>
                ...
                <a class="ui item" href="?opcion=productos"><i class="tags  icon"></i><label>Productos</label> </a>
                <a class="ui item" href="?opcion=inventario"><i class="boxes icon"></i><label>Inventario</label></a>
                <a class="ui item" href="?opcion=List_Producto"><i class="file alternate icon"></i><label>Listado de
                        Productos</label></a>
    ...
    <div class="ui item" style="margin: 0 auto 0 auto;">
        ...
        <div class="ui dropdown item"><i class="shopping  cart icon"></i>Modulo Ventas <i class="dropdown icon"></i>
            <div class="menu">
                ...
                <a class="ui item" href="?opcion=list_ventas"><i class="file alternate icon"></i><label>Registro
                        Facturas</label></a>
            </div>
        </div>
