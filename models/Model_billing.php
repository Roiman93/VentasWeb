...
class Model_billing extends ActiveRecord
{
                ...
                if ($resul_dt['id'] && $resul_dt['id'] > 0) {
                    ...
                    if (!empty($resp_pr) && is_array($resp_pr)) 
                    {
                        ...
                        if ($result_prefj['resultado'] === true) {
                            ...
                            $condiciones = array('token_user' => $token);
    ...
    public static function get_detalle_product()
    {
        ...
        if ($dates_val === true) {
            ...
            $tables = array('detalle_tmp_factura', 'producto');
            $joins = array('producto.id_producto = detalle_tmp_factura.id_producto');
            $fields = array('detalle_tmp_factura.id as id ',
